...
class PCADViewerFrame: public wxFrame
{
    ...
    private:
        ...
        wxString main_windows_name = wxTRANSLATE("ПиКАДоГляд - просмотрщик-конвертер PCAD-файлов");
        ...
        static const wxWindowID ID_PANEL_VIEW_CANVAS;
        static const wxWindowID ID_SCROLLBAR_HOR_POS;
        static const wxWindowID ID_SCROLLBAR_HOR_CANVAS;
        static const wxWindowID ID_SCROLLBAR_VERT_POS;
        static const wxWindowID ID_SCROLLBAR_VERT_CANVAS;
        static const wxWindowID ID_STATUSBAR1;
        static const wxWindowID ToolOpenFile;
        static const wxWindowID ToolCloseFile;
        static const wxWindowID ToolExit;
        static const wxWindowID ToolExport;
        static const wxWindowID ToolPrint;
        static const wxWindowID ToolFileInfo;
        static const wxWindowID ToolMark;
        static const wxWindowID ToolInvertMark;
        static const wxWindowID ToolUnmarkAll;
        static const wxWindowID ToolCopy;
        static const wxWindowID ToolScalDownX;
        static const wxWindowID ID_COMBOBOX_SCALE_X;
        static const wxWindowID ToolScaleUpX;
        static const wxWindowID ToolOneToOneX;
        static const wxWindowID ToolEqualScales;
        static const wxWindowID ToolScalDownY;
        static const wxWindowID ID_COMBOBOX_SCALE_Y;
        static const wxWindowID ToolScaleUpY;
        static const wxWindowID ToolOneToOneY;
        static const wxWindowID ID_SPINCTRL_CANVAS_HOR;
        static const wxWindowID ID_SPINCTRL_CANVAS_VERT;
        static const wxWindowID ToolCanvasYesNo;
        static const wxWindowID ToolCanvasLandscape;
        static const wxWindowID ToolHelp;
        static const wxWindowID ID_TOOLBAR_MAIN;
        static const wxWindowID IdMenuLoad;
        static const wxWindowID IdMenuLoadAs;
        static const wxWindowID IdMenuClose;
        static const wxWindowID IdMenuDrillBitSetup;
        static const wxWindowID IdMenuDrillParams;
        static const wxWindowID IdMenuCreateDrillFile;
        static const wxWindowID ID_MENUITEM1;
        static const wxWindowID IdMenuExportCanvas;
        static const wxWindowID IdMenuExportSelected;
        static const wxWindowID IdMenuExportContour;
        static const wxWindowID IdMenuExportText;
        static const wxWindowID IdMenuExportDXF;
        static const wxWindowID IdMenuExportSVG;
        static const wxWindowID IdMenuExportWMF;
        static const wxWindowID IdMenuExportBMP;
        static const wxWindowID IdMenuExportJPG;
        static const wxWindowID ID_MENUITEM_EXPORT;
        static const wxWindowID IdMenuFileInfo;
        static const wxWindowID IdMenuPrintCanvas;
        static const wxWindowID IdMenuPrintSelected;
        static const wxWindowID IdMenuPrintContour;
        static const wxWindowID IdMenuPrint;
        static const wxWindowID ID_MENUITEM_PRINT;
        static const wxWindowID IdMenuExitProgram;
        static const wxWindowID IdMenuDoCopyToClipboardAuto;
        static const wxWindowID IdMenuHandleCanvas;
        static const wxWindowID IdMenuHandleSelected;
        static const wxWindowID IdMenuHandleContour;
        static const wxWindowID IdMenuSelect;
        static const wxWindowID IdMenuInvertSelection;
        static const wxWindowID IdMenuUnselect;
        static const wxWindowID IdMenuDoCopyToClipboardSpec;
        static const wxWindowID IdMenuScaleMode;
        static const wxWindowID IdMenuItemEqualScales;
        static const wxWindowID IdMenuItemDiffScales;
        static const wxWindowID IdMenuScaleUpX;
        static const wxWindowID IdMenuScaleDownX;
        static const wxWindowID IdMenuScaleOneX;
        static const wxWindowID IdMenuNearestStdScaleX;
        static const wxWindowID IdMenuScaleUpY;
        static const wxWindowID IdMenuScaleDownY;
        static const wxWindowID IdMenuScaleOneY;
        static const wxWindowID IdMenuNearestStdScaleY;
        static const wxWindowID IdMenuScaleUpBoth;
        static const wxWindowID IdMenuScaleDownBoth;
        static const wxWindowID IdMenuScaleOneBoth;
        static const wxWindowID IdMenuNearestStdScaleXY;
        static const wxWindowID IdMenuScaleEqualX;
        static const wxWindowID IdMenuScaleEqualY;
        static const wxWindowID IdMenuScale;
        static const wxWindowID IdMenuLayers;
        static const wxWindowID IdMenuFonts;
        static const wxWindowID IdMenuLanguages;
        static const wxWindowID IdMenuCanvasA3;
        static const wxWindowID IdMenuCanvasA4;
        static const wxWindowID IdMenuCanvasA5;
        static const wxWindowID IdMenuCanvasA6;
        static const wxWindowID IdMenuCanvasA7;
        static const wxWindowID IdMenuCanvasA8;
        static const wxWindowID IdMenuCanvasVary;
        static const wxWindowID IdMenuStdSizes;
        static const wxWindowID IdMenuCanvasFixRatio;
        static const wxWindowID IdMenuCanvasMetric;
        static const wxWindowID IdMenuCanvasPortrait;
