...
{  // Описание отдельного вывода некоторого радиоэлемента (секция PIN_DEF PDIF-документа).
    ...
    std::variant<int, std::string> pin_type = 0;
...
public:
    ...
    void RadioComponentDescClear() noexcept;    // Функция-член общей очистки данных этой структуры.
...
public:
    ...
    void RadioComponentInsertionClear() noexcept ; // Функция-член общей очистки данных этой структуры.
...
public:
    ...
    void NetDefDescClear() noexcept;     // Функция-член общей очистки данных этой структуры.
